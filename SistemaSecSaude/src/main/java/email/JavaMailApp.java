      ...
      public void enviarEmail(List<String> bairros){
    	  ...
    	  Properties props = new Properties();
            ...
            try {
                  ...
                  message.setSubject("Alerta Secretaria de Saude");//Assunto
                  message.setText("Presença do mosquito localizada nos bairros " + bairros +"! Preparem-se para uma possível epidemia!");
                  
                  /**Método para enviar a mensagem criada*/
                  Transport.send(message);
 
                  System.out.println("E-mail enviado a Secretaria de saude.");
