...
public class Servidor {
	...
	public static void main(String args[]) throws Exception {
		...
		factoryBean.setAddress("http://192.168.0.101:9003/");//para acessar em rede local em casa
		//factoryBean.setAddress("http://localhost:9003/"); //para acessar na pr�pria m�quina
		//factoryBean.setAddress("http://10.62.8.239:9003/");
		//factoryBean.setAddress("http://172.26.192.215:9003/");//para acessar a rede da USP ICMC 802
		
		//cria uma instancia do servidor e inicia-lo
		Server server = factoryBean.create();
		System.out.println("\n\n#############  Servidor [Sec Servicos Publicos] pronto  #############\n\n");
